...
//track bounbary
glColor3f(0.647059,0.164706,1.0);
glBegin(GL_POLYGON);
glVertex2f(-100,100);
glVertex2f(-100,150);
glVertex2f(1100,150);
...
//roof
glColor3f(1.0,0.419608,0.137255);
glBegin(GL_POLYGON);
glVertex2f(350,450);
glVertex2f(450,500);
glVertex2f(900,500);
...
glColor3f(0.847059,1.0,0.74902);
glBegin(GL_POLYGON);
glVertex2f(425,250);
glVertex2f(425,250);
glVertex2f(425,400);
...
glColor3f(0.258824,1.0,0.258824);
glBegin(GL_POLYGON);
...
glColor3f(0.309804,0.184314,1.0);
glBegin(GL_POLYGON);
...
{
int c_menu;
	printf("Project by Avijit Ghosh\n");
    printf("--------------------------------------------------------------------------------");
